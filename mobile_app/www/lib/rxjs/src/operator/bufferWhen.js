System.register(["../Subscription", "../util/tryCatch", "../util/errorObject", "../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var Subscription_1, tryCatch_1, errorObject_1, OuterSubscriber_1, subscribeToResult_1, BufferWhenOperator, BufferWhenSubscriber;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @extends {Ignored}
             */
            BufferWhenSubscriber = class BufferWhenSubscriber extends OuterSubscriber_1.OuterSubscriber {
