System.register(["../observable/ArrayObservable", "../util/isArray", "../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var ArrayObservable_1, isArray_1, OuterSubscriber_1, subscribeToResult_1, none, CombineLatestOperator, CombineLatestSubscriber;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @extends {Ignored}
             */
            CombineLatestSubscriber = class CombineLatestSubscriber extends OuterSubscriber_1.OuterSubscriber {
