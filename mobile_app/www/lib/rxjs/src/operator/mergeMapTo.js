System.register(["../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var OuterSubscriber_1, subscribeToResult_1, MergeMapToOperator, MergeMapToSubscriber;
    return {
        setters: [
        ...
        execute: function () {
            ...
            MergeMapToOperator = class MergeMapToOperator {
             ...
             * @extends {Ignored}
             */
            MergeMapToSubscriber = class MergeMapToSubscriber extends OuterSubscriber_1.OuterSubscriber {
