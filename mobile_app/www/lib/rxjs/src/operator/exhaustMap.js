System.register(["../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var OuterSubscriber_1, subscribeToResult_1, SwitchFirstMapOperator, SwitchFirstMapSubscriber;
    return {
        setters: [
        ...
        execute: function () {
            SwitchFirstMapOperator = class SwitchFirstMapOperator {
             ...
             * @extends {Ignored}
             */
            SwitchFirstMapSubscriber = class SwitchFirstMapSubscriber extends OuterSubscriber_1.OuterSubscriber {
