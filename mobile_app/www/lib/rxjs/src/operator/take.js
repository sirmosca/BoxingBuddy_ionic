System.register(["../Subscriber", "../util/ArgumentOutOfRangeError", "../observable/EmptyObservable"], function (exports_1, context_1) {
    ...
    exports_1("take", take);
    var Subscriber_1, ArgumentOutOfRangeError_1, EmptyObservable_1, TakeOperator, TakeSubscriber;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @extends {Ignored}
             */
            TakeSubscriber = class TakeSubscriber extends Subscriber_1.Subscriber {
