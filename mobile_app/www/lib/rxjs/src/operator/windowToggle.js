System.register(["../Subject", "../Subscription", "../util/tryCatch", "../util/errorObject", "../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var Subject_1, Subscription_1, tryCatch_1, errorObject_1, OuterSubscriber_1, subscribeToResult_1, WindowToggleOperator, WindowToggleSubscriber;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @extends {Ignored}
             */
            WindowToggleSubscriber = class WindowToggleSubscriber extends OuterSubscriber_1.OuterSubscriber {
