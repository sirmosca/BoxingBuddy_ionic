System.register(["../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var OuterSubscriber_1, subscribeToResult_1, SwitchMapOperator, SwitchMapSubscriber;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @extends {Ignored}
             */
            SwitchMapSubscriber = class SwitchMapSubscriber extends OuterSubscriber_1.OuterSubscriber {
