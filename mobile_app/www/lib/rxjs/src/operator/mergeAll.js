System.register(["../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var OuterSubscriber_1, subscribeToResult_1, MergeAllOperator, MergeAllSubscriber;
    return {
        setters: [
        ...
        execute: function () {
            MergeAllOperator = class MergeAllOperator {
             ...
             * @extends {Ignored}
             */
            MergeAllSubscriber = class MergeAllSubscriber extends OuterSubscriber_1.OuterSubscriber {
