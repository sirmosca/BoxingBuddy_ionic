System.register(["../Subscriber", "../Subscription", "../Observable", "../Subject", "../util/Map", "../util/FastMap"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
             ...
             * @extends {Ignored}
             */
            GroupBySubscriber = class GroupBySubscriber extends Subscriber_1.Subscriber {
             ...
             * @extends {Ignored}
             */
            GroupDurationSubscriber = class GroupDurationSubscriber extends Subscriber_1.Subscriber {
             ...
             */
            GroupedObservable = class GroupedObservable extends Observable_1.Observable {
             ...
             * @extends {Ignored}
             */
            InnerRefCountSubscription = class InnerRefCountSubscription extends Subscription_1.Subscription {
                constructor(parent) {
                    super();
                    this.parent = parent;
                    parent.count++;
