System.register(["../scheduler/async", "../Subscriber"], function (exports_1, context_1) {
    ...
    var async_1, Subscriber_1, AuditTimeOperator, AuditTimeSubscriber;
    return {
        setters: [
            function (async_1_1) {
                async_1 = async_1_1;
        ...
        execute: function () {
            AuditTimeOperator = class AuditTimeOperator {
             ...
             * @extends {Ignored}
             */
            AuditTimeSubscriber = class AuditTimeSubscriber extends Subscriber_1.Subscriber {
