System.register(["../OuterSubscriber", "../util/subscribeToResult"], function (exports_1, context_1) {
    ...
    var OuterSubscriber_1, subscribeToResult_1, SwitchMapToOperator, SwitchMapToSubscriber;
    return {
        setters: [
        ...
        execute: function () {
            SwitchMapToOperator = class SwitchMapToOperator {
             ...
             * @extends {Ignored}
             */
            SwitchMapToSubscriber = class SwitchMapToSubscriber extends OuterSubscriber_1.OuterSubscriber {
