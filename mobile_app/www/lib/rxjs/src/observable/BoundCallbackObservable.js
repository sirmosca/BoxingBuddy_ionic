System.register(["../Observable", "../util/tryCatch", "../util/errorObject", "../AsyncSubject"], function (exports_1, context_1) {
    ...
    var Observable_1, tryCatch_1, errorObject_1, AsyncSubject_1, BoundCallbackObservable;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @hide true
             */
            BoundCallbackObservable = class BoundCallbackObservable extends Observable_1.Observable {
