System.register(["../Observable", "../util/tryCatch", "../util/errorObject", "../AsyncSubject"], function (exports_1, context_1) {
    ...
    function dispatch(state) {
        ...
        if (!subject) {
            ...
            const result = tryCatch_1.tryCatch(callbackFunc).apply(context, args.concat(handler));
            if (result === errorObject_1.errorObject) {
                self.add(scheduler.schedule(dispatchError, 0, { err: errorObject_1.errorObject.e, subject }));
            }
        }
    ...
    var Observable_1, tryCatch_1, errorObject_1, AsyncSubject_1, BoundNodeCallbackObservable;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @hide true
             */
            BoundNodeCallbackObservable = class BoundNodeCallbackObservable extends Observable_1.Observable {
                ...
                _subscribe(subscriber) {
                    ...
                    if (!scheduler) {
                        if (!subject) {
                            ...
                            handler.source = this;
                            const result = tryCatch_1.tryCatch(callbackFunc).apply(this.context, args.concat(handler));
                            if (result === errorObject_1.errorObject) {
                                subject.error(errorObject_1.errorObject.e);
                            }
                        }
