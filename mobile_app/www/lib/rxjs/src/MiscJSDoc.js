System.register(["./Observable", "./observable/dom/MiscJSDoc"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var Observable_1, ObservableDoc, ObserverDoc, SubscribableOrPromiseDoc, ObservableInputDoc, TeardownLogicDoc;
    return {
        setters: [
        ...
        execute: function () {
             ...
             * @hide true
             */
            ObservableDoc = class ObservableDoc {
                /**
             ...
             * @noimport true
             */
            SubscribableOrPromiseDoc = class SubscribableOrPromiseDoc {
            };
            exports_1("SubscribableOrPromiseDoc", SubscribableOrPromiseDoc);
            /**
             ...
             * @noimport true
             */
            ObservableInputDoc = class ObservableInputDoc {
            };
            exports_1("ObservableInputDoc", ObservableInputDoc);
            /**
             *
             ...
             * @noimport true
             */
            TeardownLogicDoc = class TeardownLogicDoc {
            };
            exports_1("TeardownLogicDoc", TeardownLogicDoc);
        }
    };
});
