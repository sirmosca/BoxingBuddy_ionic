System.register(["../Observable", "../Notification", "./ColdObservable", "./HotObservable", "./SubscriptionLog", "../scheduler/VirtualTimeScheduler"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var Observable_1, Notification_1, ColdObservable_1, HotObservable_1, SubscriptionLog_1, VirtualTimeScheduler_1, defaultMaxFrame, TestScheduler;
    return {
        setters: [
        ...
        execute: function () {
            defaultMaxFrame = 750;
            TestScheduler = class TestScheduler extends VirtualTimeScheduler_1.VirtualTimeScheduler {
